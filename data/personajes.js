window.PERSONAJES = [
  ...
  },
  {
    ...
    content: `
      ...
      incertidumbre, partió de viaje decidido a entender las emociones, las
      suyas y las ajenas, de una vez por todas. El ataque del dragón no
      entraba, ni de lejos, en sus planes.</p>
    `
  },
  {
    id: "eledar-a",
  ...
  },
  {
    ...
    category: "Personajes",
    tags: ["jugador", "humano"],
    summary: "Explorador humano, charlatán vaquero criado en Vado Ceniza, cobarde y codicioso pero extrañamente carismático; se unió al grupo camino al norte a cambio de una paga.",
    retrato: "",
    titulo: "Explorador",
    raza: "Humano",
    tipo: "Jugador",
