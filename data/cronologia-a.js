window.CRONOLOGIA_A = [
  {
    ...
    content: `
      ...
      quien intentó comprar la libertad de la criatura, y quien decidió simplemente
      tomarla. Las voces subieron de tono, las mesas se movieron, y por un momento La
      Taberna del Gigante estuvo más cerca de vivir su nombre de lo que a su tabernero le
      hubiera gustado. Fue él quien puso fin al altercado antes de que se convirtiera en
      algo peor, echando a Las Comadrejas a la calle o, según se cuente la historia,
      calmando los ánimos con la autoridad de quien ya ha visto demasiadas peleas de
      taberna.</p>

      <p>Nadie en aquella sala sabía que sería la última noche tranquila que la ciudad
      tendría en mucho tiempo.</p>
      ...
      refugio no fue una línea recta: hubo civiles que sacar de edificios que ya no eran
      seguros, incendios que apagar antes de que se llevaran una manzana entera, escombros
      que mover para que otros pudieran pasar. No fue una noche de héroes deliberados,
      sino de gente que, estando en el lugar equivocado en el momento peor, eligió no
  ...
  },
  {
    ...
    content: `
      ...
      decidiendo, barricada por barricada, que no pensaba rendirse.</p>
  ...
  },
  {
    ...
    numero: "Capítulo III",
    title: "El Castillo",
    fecha: "La noche en que se convirtieron en fugitivos",
    content: `
      ...
      para decidir el resto de la noche.</p>

      <p>Los protagonistas huyeron de Brurland mientras empezaban a aparecer los
      primeros carteles de búsqueda y los pregoneros anunciaban la noticia por las
      calles. Los héroes del refugio habían muerto. El dragón había escapado. Y
      ellos, que apenas unas horas antes habían ayudado a salvar la ciudad, eran
      ahora los criminales más buscados del reino.</p>
    `
  },
  {
    id: "capitulo-4",
    orden: 4,
    numero: "Capítulo IV",
    title: "El Descanso del Trasgo",
    fecha: "Fugitivos en su propio reino",
    content: `
      <p>El granero abandonado en las afueras de Brurland se convirtió en el único
      techo que los protagonistas podían llamar propio. Ahí procesaron lo ocurrido en
      el refugio, conscientes de que Ocevat y Verdam, los últimos héroes en llegar
      antes de la masacre, habían sido su condena. Mientras el reino entero los
      buscaba por un crimen que no cometieron, necesitaban recursos, aliados y
      respuestas.</p>

      <p>Conseguir cualquiera de las tres cosas sin ser capturados significaba
      arriesgarse en una taberna de mala muerte conocida como El Descanso del
      Trasgo.</p>

      <h4>El Descanso del Trasgo</h4>

      <p>El ambiente dentro estaba cargado de humo, alcohol y una desconfianza que no
      distinguía entre clientes. En las paredes colgaban carteles de "Se Busca" con
      sus propios rostros, acusándolos de la muerte de civiles, aldeanos y un niño
      entre ellos. Pasar desapercibidos exigió toda la discreción que pudieron
      reunir.</p>

      <p>Gareth, el semigigante al que habían ayudado tiempo atrás contra la Bestia
      Trémula, bebía solo en una esquina. El favor que les debía seguía en pie, y con
      él, la posibilidad de contar con refugio o ayuda si necesitaban escapar otra
      vez.</p>
      ...
      recompensa ofrecida por los responsables de la masacre. Fue él quien mencionó,
      casi de pasada, que Verdam pagaba una recompensa adicional propia por
      cualquier información que condujera hasta el escondite de los protagonistas.</p>

      <p>No muy lejos, un comerciante elegantemente vestido intentaba convencer a un
      campesino de vender sus tierras a un precio ridículo, aprovechando el desastre
      reciente. Y en un rincón más oscuro, un cazador de recompensas mantenía
      encadenado a un kobold completamente aterrorizado, apenas capaz de hablar.</p>
    `
  },
  {
    id: "capitulo-5",
    ...
    content: `
      ...
      <p>Mientras intentaban reunir algunas monedas para sobrevivir, varios clientes
      terminaron reconociéndolos gracias a los carteles de búsqueda repartidos por
      toda la sala. La tensión escaló con rapidez hasta convertirse en una pelea
